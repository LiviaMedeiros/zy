...
const run = async ([ version, zy ], t) => {
  await t.test(`toObject method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test(`toZonedDateTime method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test(`toInstant method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test(`toISO method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
        () => zy.toISO(`${ż}gwak${ẏ}`),
        TypeError
  ...
  await t.test(`toSeconds method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test('toMilliseconds method', t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test(`toMicroseconds method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
  ...
  await t.test(`toNanoseconds method on ${version}`, t => {
    wrap((ż, ẏ) => {
      assert.throws(
