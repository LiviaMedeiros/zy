...
const run = async ([ version, zy ], t) => {
  await t.test(`fromZonedDateTime method on ${version}`, t => {
    assert.throws(
  ...
  await t.test(`fromDate method on ${version}`, t => {
    assert.throws(
      () => zy.fromDate(`gwak`),
      TypeError
    );
  ...
  await t.test(`fromISO method on ${version}`, t => {
    assert.throws(
      () => zy.fromISO(`gwak`),
      TypeError
    );
  ...
  await t.test(`fromInstant method on ${version}`, t => {
    assert.throws(
      () => zy.fromInstant(`gwak`),
      TypeError
    );
  ...
  await t.test(`fromString method on ${version}`, t => {
    assert.throws(
      () => zy.fromString(`gwak`),
      RangeError
    );
  ...
  await t.test(`fromSeconds method on ${version}`, t => {
    assert.throws(
      () => zy.fromSeconds(`gwak`),
      RangeError
    );
  ...
  await t.test(`fromMilliseconds method on ${version}`, t => {
    assert.throws(
  ...
  await t.test(`fromMicroseconds method on ${version}`, t => {
    assert.throws(
  ...
  await t.test(`fromNanoseconds method on ${version}`, t => {
    assert.throws(
  ...
  await t.test(`fromNumber method on ${version}`, t => {
    assert.throws(
      () => zy.fromNumber(`gwak`),
      RangeError
    );
  ...
  await t.test(`fromBigInt method on ${version}`, t => {
    assert.throws(
      () => zy.fromBigInt(`gwak`),
      SyntaxError
    );
